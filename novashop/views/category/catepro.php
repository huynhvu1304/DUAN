                ...
                <div class="row pb-3">
                    <div class="col-12 pb-1">
                        ...
                        <?php
                            ...
                            $categoryId = isset($_GET['id']) ? intval($_GET['id']) : 0; // Lấy ID từ URL
                    ...
                    <?php foreach ($products as $product) { ?>
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="<?=$baseurl?>/addtocart/<?= $product['id'] ?>"><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="text-center py-4">
                             ...
                             if (isset($product['sale'])) {
                                ...
                                echo '<h5 style="color: red;">' . number_format((float)$product['sale'], 0, ',', '.') . 'đ</h5>';
                                echo '<h6 class="text-muted ml-2"><del>' . number_format((float)$product['price'], 0, ',', '.') . 'đ</del></h6>';
                                } else {
